...
void maj_menu_clic(int x, int y,Menu *m)
{
        ...
        x> MAP_WIDTH*TILE_WIDTH*RENDER_SCALE - 10*TAILLE_CHAR_W*RENDER_SCALE && MAP_WIDTH*TILE_WIDTH*RENDER_SCALE - 2*TAILLE_CHAR_W*RENDER_SCALE)
        {
         ...
         if (y> (7*TILE_HEIGHT + HUD_HEIGHT*RENDER_SCALE) && (7*TILE_HEIGHT*RENDER_SCALE + HUD_HEIGHT*RENDER_SCALE)+3*TAILLE_CHAR_W*RENDER_SCALE &&
        x> (MAP_WIDTH*TILE_WIDTH*RENDER_SCALE - 6*TAILLE_CHAR_W*RENDER_SCALE) && (MAP_WIDTH*TILE_WIDTH*RENDER_SCALE - 6*TAILLE_CHAR_W*RENDER_SCALE)+3*TAILLE_CHAR_W*RENDER_SCALE)
        {
            m->volume_son++;
            if (m->volume_son ==4)
                m->volume_son =0;
